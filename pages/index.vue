  ...
  id="main" class="absolute text-white text-center w-full max-w-2xl px-6"
    ...
    >
      ...
      ONE WTIH AN EVERLASTING DESIRE
       FOR THE UNKNOWN</p>
    <a  id="view" class="border px-4 py-2 rounded-lg text-sm font-space-mono uppercase mt-8 hover:bg-white hover:text-gray-800 inline-block opacity-0 " style="transform: translateY(30px)" >View Work </a>
  </div>
</div>
</template>
...
for (let i = 0; i < array.length; i+=3) {
  ...
  //y
  array[i+1] = originalPosition[i+1] + Math.sin(frame + randomValues[i+1]) * 0.09
